...
jdbc_jar_s3_path = "s3://realtime-food-delivery-data-analysis/redshift-connector-jar/redshift-jdbc42-2.1.0.12.jar"
    ...
    steps=[{
        ...
        'HadoopJarStep': {
            ...
            'Args': [
                ...
                's3://realtime-food-delivery-data-analysis/pyspark_script/pyspark_streaming.py',
