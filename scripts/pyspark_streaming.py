...
checkpointLocation = "s3://emr-stream-checkpointing/kinesisToRedshift/"
redshiftJdbcUrl = f"jdbc:redshift://redshift-cluster-1.c1winzwcadxg.us-east-1.redshift.amazonaws.com:5439/dev"
redshiftTable = "food_delivery_datamart.factOrders"
tempDir = "s3://redshift-temp-data-loc/temp-data/streaming_temp/"
